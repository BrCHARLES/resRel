...
@section('description', '{{ __("Ressources Relationnelles est un site du ministère des solidarités et de la santé pour améliorer notre communication au quotidien")}}')
